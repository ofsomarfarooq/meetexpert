...
const Avatar = () => (
  ...
  const HeaderActions = () => (
    <div className="ml-auto flex flex-wrap gap-2">
      {isOwner && (
        <button className="btn btn-outline" onClick={() => setEditModal(true)}>
          Edit Profile
        </button>
      )}
      ...
      {isExpert ? (
        ...
        isOwner && (
          <button className="btn btn-primary" onClick={() => setBeModal(true)}>
            Become Expert
          </button>
        )
      )}
  ...
  return (
    <>
              ...
              <div className="mt-2">
                ...
                {isExpert ? (
                  <div className="mt-2 flex flex-wrap items-center gap-3 text-sm">
                    ...
                    <div>
                      {headerRating.avg} ★
                      <span className="opacity-60"> ({headerRating.total})</span>
                    </div>
                    <div className="opacity-70">•</div>
                    <div>
      ...
      {/* Become Expert / Edit Expert Modal */}
      {beModal && (
        <dialog open className="modal">
          <div className="modal-box max-w-xl">
            <h3 className="font-bold text-lg mb-3">
              {isExpert && isOwner ? "Edit expert profile" : "Become an Expert"}
            </h3>
            ...
            <div className="grid gap-2">
              ...
              <select
                ...
                value={beSkill}
                onChange={(e) => setBeSkill(e.target.value)}
              >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                <input
                  ...
                  value={beCompany}
                  onChange={(e) => setBeCompany(e.target.value)}
                />
                <input
                  className="input input-bordered w-full"
                  placeholder="Position (optional)"
                  value={bePosition}
                  onChange={(e) => setBePosition(e.target.value)}
                />
              </div>
